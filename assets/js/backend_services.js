...
(function (exports) {
    ...
    var categoriesTemplateHelper = new CategoriesTemplateHelper();
    ...
    function bindEventHandlers() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function () {
            if ($(this).attr('href') === '#services') {
                ...
                helper.filterCategoriesTemplate('');
            } else if ($(this).attr('href') === '#categories_template') {
                helper = categoriesTemplateHelper;
            }
        ...
        categoriesTemplateHelper.bindEventHandlers();
    }
