...
($context["allow_user_drop_database"] ?? null)]);
    ...
    {
        return new Twig_Source("", "server/databases/databases_header.twig", "/Applications/phpstudy/WWW/phpMyAdmin4.8.5/templates/server/databases/databases_header.twig");
    }
}
