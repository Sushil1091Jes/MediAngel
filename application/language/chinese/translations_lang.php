...
$lang['Female'] = '女';
$lang['Child'] = '小孩';
$lang['headPic_upload'] = '请上传头像';
$lang['headPic_upload_error'] = '头像上传失败，请重新上传';
$lang['image'] = '图片';
$lang['image_upload'] = '请上传图片';
$lang['image_upload_error'] = '图片上传失败 ,请重新上传';
$lang['categories_template'] = '类别模板';
$lang['service_category_template_saved'] = '服务类别模板成功保存.';
$lang['service_category_template_deleted'] = '服务类别模板成功删除.';
$lang['service_category_template_select'] = '选择类别模板';
$lang['confirm'] = '确认';
$lang['sms_code_title'] = '验证码';
$lang['sms_code_msg'] = ' 您正在进行<span style="color: red">邮箱验证</span>操作，请在验证码输入框中输入：<span style="color:#f60;">$code</span>，以完成操作。';
