...
$lang['about_app'] = 'About MediAngel';
...
$lang['about_app_info'] = 'MediAngel is a highly customizable web application that allows your patients to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using MediAngel you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'MediAngel is licensed under the GPLv3 license. By using the code of MediAngel in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'MediAngel has been successfully updated.';
...
$lang['require_phone_number_hint'] = 'When enabled, patients and users will need to enter the customer\'s phone number when booking an appointment';
$lang['check_spam_folder'] = 'Please check your spam folder if the email does not arrive within a few minutes.';
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the MediAngel API.';
...
$lang['Female'] = 'Female';
$lang['Child'] = 'Child';
$lang['headPic_upload'] = 'Please upload your picture';
$lang['headPic_upload_error'] = 'Failed to upload the avatar. Please upload again';
$lang['image'] = 'picture';
$lang['image_upload'] = 'Please upload the picture';
$lang['image_upload_error'] = 'Failed to upload image, please upload again';
$lang['categories_template'] = 'Categories Template';
$lang['service_category_template_saved'] = 'Service category template saved successfully.';
$lang['service_category_template_deleted'] = 'Service category template deleted successfully.';
$lang['service_category_template_select'] = 'Select category template';
$lang['confirm'] = 'confirm';
$lang['sms_code_title'] = 'Verification Code';
$lang['sms_code_msg'] = 'Your verification code is <strong>$code</strong> , valid for <strong>5</strong> minutes , you are in the process of mailbox verification operation , if not my operation , please ignore.';
