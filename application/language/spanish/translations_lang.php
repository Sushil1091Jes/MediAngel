...
$lang['about_app'] = 'Acerca de MediAngel';
...
$lang['about_app_info'] = 'MediAngel es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] = 'El grupo oficial de respuestas de Google Groups se encuentra a su disposición, en caso de que encuentre algún inconveniente con MediAngel.  También podrá informar incidentes en la página de Google Code y así ayudar en el proceso de desarrollo de la herramienta.';
...
$lang['about_app_license'] = 'MediAngel se encuentra bajo licencia GPLv3. Todo tipo de uso del código de MediAngel presume la aceptación de los términos desciptos en la siguiente dirección web:';
...
$lang['ea_update_success'] = 'MediAngel ha sido actualizado exitosamente';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de MediAngel.';
...
$lang['sms_code_msg'] = 'You are in progress<span style="color: red"> email verification </span>operation，please input the verification code in the input box：<span style="color:#f60;">$code</span>，to complete the operation';
