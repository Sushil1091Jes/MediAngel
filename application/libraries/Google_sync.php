 ...
 * and the MediAngel system. Do not place any model handling inside this
 * library.
 *
 * @package Libraries
 */
class Google_Sync {
     ...
     * where the user grants access to his data for the MediAngel app.
     */
     ...
     * when the provider granted consent to MediAngel for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of MediAngel
     ...
     * provided appointment record of MediAngel.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
