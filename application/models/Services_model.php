...
class Services_model extends EA_Model {
    ...
    public function get_available_services()
    {
        ...
        return $this->db
            ->select('services.*, service_categories.name AS category_name, '
                . 'service_categories.id AS category_id,service_categories.image AS category_image')
            ->from('services')
    ...
    public function get_all_categories($where = NULL, $order_by = NULL, $limit = NULL, $offset = NULL)
    {
      ...
      /**
     * This method returns all the categories from the database.
     *
     * @return array Returns an object array with all the database category.
     */
    public function get_available_categories()
    {
        ...
        $this->db
                ...
                ->join('service_categories', 'service_categories.id = services.id_service_categories', 'inner')
