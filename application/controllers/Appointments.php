...
class Appointments extends EA_Controller {
    ...
    public function index($appointment_hash = '')
    {
        try
        {
            ...
            if ($appointment_hash !== '')
            {
                ...
                $results = $this->appointments_model->get_batch(['hash' => $appointment_hash,'status'=>1]);
    ...
    public function cancel($appointment_hash)
    {
        try
        {
            ...
            $appointments = $this->appointments_model->get_batch(['hash' => $appointment_hash,'status'=>1]);
            ...
            if ( ! $this->appointments_model->delete($cancel_appointment['id']))
            {
