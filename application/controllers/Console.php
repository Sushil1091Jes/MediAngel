 ...
 * Class Console
 *
 * CLI commands of MediAngel, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method in a cronjob to automatically sync events between MediAngel and Google Calendar.
     *
     * Notice:
     *
