...
<head>
	...
	<title>Installation | MediAngel</title>
...
<body>
    ...
    <header>
        <div class="container">
            <h1 class="page-title">MediAngel Installation</h1>
        </div>
    </header>

    <div class="content container">
        <div class="welcome">
            <h3>Welcome to the MediAngel installation page.</h3>
            <p>
                This page will help you set the main settings of your MediAngel installation.
                ...
                url to connect to the backend section of MediAngel.

                If you face any problems during the usage of MediAngel you can always check the
        ...
        <p>
            <h3>License</h3>
            MediAngel is licensed under the <span class="badge badge-default">GPLv3 license</span>.
            By using the code of MediAngel in any way <br> you agree with the terms described in the
            following url:
        ...
        <button type="button" id="install" class="btn btn-success btn-large">
            ...
            Install MediAngel</button>
    </div>

    <footer>
        Powered by <a href="https://www.azaas.com">aZaaS</a>
    </footer>
